...
public class EnableFirewallShortcut extends Activity {
	
	public void onCreate(Bundle savedInstanceState){
		super.onCreate(savedInstanceState);
		
		Intent intent = new Intent(Intent.ACTION_MAIN);
		intent.setClassName(this, EnableFirewall.class.getName());
		...
		intent2.putExtra(Intent.EXTRA_SHORTCUT_NAME, getString(R.string.fw_enabled));

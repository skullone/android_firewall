/**
 * Shortcut for Enabling Profile 2 via MacroDroid or Llama
 * 
...
public class Profile2Shortcut extends Activity {
	...
	public void onCreate(Bundle savedInstanceState){
		...
		intent.setClassName(this, Profile2.class.getName());
		...
		intent2.putExtra(Intent.EXTRA_SHORTCUT_NAME, Profile2);

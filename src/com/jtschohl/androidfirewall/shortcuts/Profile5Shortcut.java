/**
 * Shortcut for Enabling Profile 5 via MacroDroid or Llama
 * 
...
public class Profile5Shortcut extends Activity {
	...
	public void onCreate(Bundle savedInstanceState){
		...
		intent.setClassName(this, Profile5.class.getName());
		...
		intent2.putExtra(Intent.EXTRA_SHORTCUT_NAME, Profile5);
